        ...
        <div class="w3ls-details">
            ...
            <form class="">
                ...
                <div class="form-group has-feedback">
                    <label for="prod_name">产品名字*</label>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-user"></span>
                        </span>
                        <input id="prod_name" name="identity" class="form-control" placeholder="请输入产品名" maxlength="20" type="text" required="" >
                    </div>
                </div>
                ...
                <div class="form-group has-feedback">
                    <label for="prod_pic_dir">图片路径*</label>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-user"></span>
                        </span>
                        <input id="prod_pic_dir" class="form-control" name="studentNumber" placeholder="请输入图片路径" maxlength="128" type="text" required="">
                    </div>
                </div>

                <div class="form-group">
                    <input class="form-control btn btn-primary" id="btn_addProductToDB" value="添&nbsp;&nbsp;加" type="submit">
                </div>
...
<script type="text/javascript" src="../../../js/systemScripts/ProductOperation.js"></script>
