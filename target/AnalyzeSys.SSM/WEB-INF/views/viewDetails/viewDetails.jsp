    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="w3ls-details">
            ...
            <div class="w3ls-text">
                ...
                <p><b>商品价格 : $</b> ${currentProduct.prod_price} </p>
                <p><b>商品描述 :</b> ${currentProduct.prod_description} </p>
            ...
            <input type="text" id="Prod_count" placeholder="请输入要买的数量" width="20px">
            <button class="btn btn-danger" id="btn_addToCart">+</button>
            <br/>
            <button class="btn btn-danger" id="btn_showCart">查看购物车</button>
